 ...
 * <p>
 * ?????????bucket????????0.5??????????????????loadfactor???log?2?????0.693?
 * ??????0.75???0.75???0.693?????????????????????????16*0.75=12???????
 *
 *
...
public class HashMap<K, V> extends AbstractMap<K, V>
     ...
     * ?????????????2???
     * ????HashMap??????????+??/??+???????????????????????????
     * i = (n - 1) & hash???????n?2?????(n - 1) & hash???n % hash????
     * n = 16?hash = 1010??(n - 1) & hash = 1111 & 1010 = 1010 = 6
     * n = 16?hash = 1010??n % hash = 1111 % 1010 = 1010 = 6
     * ??????????????????????
     * ???????&?????%??????
     * ????? a % b????a-(a / b)*b ????
     * ???? ???????
    ...
    static final int hash(Object key) {
        ...
        //          hashmap??????????hash??????
        //          ???hashCode??1954974080
        //          ?hashCode? 0111 0100 1000 0110 1000 1001 1000 0000
        ...
        //          ??????
        //          ?hashCode?             0111 0100 1000 0110 1000 1001 1000 0000
        //          (>>>16)?????16??    0000 0000 0000 0000 0111 0100 1000 0110
        //-----------^ ????----------------------------------------------------------
    ...
    final Node<K, V>[] resize() {
         ...
         * ????????????hash???????????????????
         * ????????????????2???????????????????????1
         * ??????16?????(n-1) & hash ????n-1?0000 1111????32??????????1??0001 1111?
         * ???& ???1???? & ?????????????????????hashcode???4??0????1????
         * ??????0???hash?????????1???hash??????16????????
         * ???            ???             ???? - 1????(n - 1)
         * ????????0?????????
         * ????16?     0000 0101    &    0000 1111 = 0000 0101 = 5
         * ???????32?0000 0101    &    0001 1111 = 0000 0101 = 5????
         * ????????1???????oldCap??
         * ????16?     0001 0101    &    0000 1111 = 0000 0101 = 5
         * ???????32?0001 0101    &    0001 1111 = 0001 0101 = 5 + 16????????16?
         */
        if (oldTab != null) {
